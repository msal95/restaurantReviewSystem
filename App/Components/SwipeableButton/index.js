...
export const renderRightAction = (
  text,
  color,
  xSlide,
  progress,
...
function SwipeableButton(props) {
  ...
  return (
    <Swipeable
      ...
      leftThreshold={30}
      rightThreshold={40}
      containerStyle={props.swipeContainerStyle ?? styles.swipeAbleContainer}
      renderRightActions={props?.renderRightActions ?? renderRightActions}
